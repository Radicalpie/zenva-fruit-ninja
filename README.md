...
Всички обекти наследяват свойствата и методите, които са притежание на техният прототип. В нашия случай всички бомби, които са създадени с `new new FruitNinja.Bomb(...)` наследяват FruitNinja.Bomb.prototype. Стандартният начин да се създаде един прототип на даден обект е като се използва функцията конструктор:
